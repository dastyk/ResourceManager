...
#line 50 "binary.tab.hh" // lalr1.cc:372
...
namespace yy {
#line 126 "binary.tab.hh" // lalr1.cc:372
  ...
  public:
    ...
    union union_type
    {
      ...
      // indices
      char dummy5[sizeof(std::vector<unsigned long>)];
    ...
    , value ()
  {
      switch (other.type_get ())
    {
      ...
      case 23: // indices
        value.copy< std::vector<unsigned long> > (other.value);
        break;
    ...
    , value ()
  {
      ...
      switch (this->type_get ())
    {
      ...
      case 23: // indices
        value.copy< std::vector<unsigned long> > (v);
        break;
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const std::vector<unsigned long> v)
    : Base (t)
    , value (v)
  {}
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
      ...
      switch (this->type_get ())
    {
      ...
      case 23: // indices
        value.move< std::vector<unsigned long> > (s.value);
        break;
...
#line 1191 "binary.tab.hh" // lalr1.cc:372
